...
class AddTodo extends Component {
  ...
  // The handleDue function is for the datepicker to set the value of your due date.
  // "event" is the defined action a user takes. In this case, the event is triggered when the picks a date.
  handleDue = (event) => {
    this.setState({
